// The following file contains code for viewing,adding and removing modules
...
public class ModuleDetails extends JFrame implements ActionListener {
    JLabel a1, a2, a3;
    JTable v1;
    JButton b1, b2;
    JTextField rr;
    ...
    ModuleDetails() {
        ...
        a1 = new JLabel("Enter Name  of the Module:");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            try {
                ...
                String delt = "delete from module_info where module_name = '" + gety + "'";
