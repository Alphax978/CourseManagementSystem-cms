// The following file contains code for Instructor Login frame
...
public class InstructorLogin extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String q = "select * from instructor_login where username='" + u + "' and passcode='" + v + "'";

            ResultSet rs = c1.x.executeQuery(q);
            if (rs.next()) {
                new InstructorPortal().setVisible(true);
                setVisible(false);
            } else {
